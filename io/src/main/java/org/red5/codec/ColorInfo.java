...
public class ColorInfo implements IExternalizable {
    ...
    public class ColorConfig implements Serializable {
        ...
        @Override
        public String toString() {
            return "ColorConfig [bitDepth=" + bitDepth + ", colorPrimaries=" + colorPrimaries
                    + ", transferCharacteristics=" + transferCharacteristics + ", matrixCoefficients="
                    + matrixCoefficients + "]";
        }
    ...
    public class HdrMdcv implements Serializable {
        ...
        @Override
        public String toString() {
            return "HdrMdcv [redX=" + redX + ", redY=" + redY + ", greenX=" + greenX + ", greenY=" + greenY + ", blueX="
                    + blueX + ", blueY=" + blueY + ", whitePointX=" + whitePointX + ", whitePointY=" + whitePointY
