...
public class VP9Video extends AbstractVideo {
     ...
     */
    static final String CODEC_NAME = "VP9";

    public static final byte[] VP8_KEYFRAME_PREFIX = new byte[] { 0x19, 0x01 };

    public static final byte[] VP8_FRAME_PREFIX = new byte[] { 0x29, 0x01 };
