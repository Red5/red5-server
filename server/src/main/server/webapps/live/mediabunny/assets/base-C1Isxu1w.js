...
var isWebKit = () => {
  ...
  return isWebKitCache = !!(typeof navigator !== "undefined" && (((_a = navigator.vendor) == null ? void 0 : _a.match(/apple/i)) || /AppleWebKit/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) || /\b(iPad|iPhone|iPod)\b/.test(navigator.userAgent)));
};
  ...
  switch (codec) {
    case "avc": {
      for (const loc of iterateAvcNalUnits(packetData, decoderConfig)) {
        ...
        if (type === 6 && (!isChromium() || getChromiumVersion() >= 144)) {
          const nalUnit = packetData.subarray(loc.offset, loc.offset + loc.length);
...
var EncodedPacket = class _EncodedPacket {
  ...
  clone(options) {
    ...
    return new _EncodedPacket(
      (options == null ? void 0 : options.data) ?? this.data,
      (options == null ? void 0 : options.type) ?? this.type,
      (options == null ? void 0 : options.timestamp) ?? this.timestamp,
      (options == null ? void 0 : options.duration) ?? this.duration,
      (options == null ? void 0 : options.sequenceNumber) ?? this.sequenceNumber,
      this.byteLength,
      (options == null ? void 0 : options.sideData) ?? this.sideData
    );
  }
};
var toUlaw = (s16) => {
...
var VideoSample = class _VideoSample {
  constructor(data, init) {
    ...
    finalizationRegistry == null ? void 0 : finalizationRegistry.register(this, { type: "video", data: this._data }, this);
  }
  ...
  drawWithFit(context, options) {
    ...
    const { sx, sy, sWidth, sHeight } = this._rotateSourceRegion(
      ((_a = options.crop) == null ? void 0 : _a.left) ?? 0,
      ((_b = options.crop) == null ? void 0 : _b.top) ?? 0,
      ((_c = options.crop) == null ? void 0 : _c.width) ?? rotatedWidth,
      ((_d = options.crop) == null ? void 0 : _d.height) ?? rotatedHeight,
      rotation
    );
    if (options.fit === "fill") {
      dx = 0;
...
var VideoSampleColorSpace = class {
  ...
  constructor(init) {
    this.primaries = (init == null ? void 0 : init.primaries) ?? null;
    this.transfer = (init == null ? void 0 : init.transfer) ?? null;
    this.matrix = (init == null ? void 0 : init.matrix) ?? null;
    this.fullRange = (init == null ? void 0 : init.fullRange) ?? null;
  }
  ...
  getDecodeQueueSize() {
    ...
    if (this.customDecoder) {
      ...
      return Math.max(
        ...
        ((_a = this.alphaDecoder) == null ? void 0 : _a.decodeQueueSize) ?? 0
      );
    }
  }
  decode(packet) {
...
var IsobmffTrackBacking = class {
  ...
  async performFragmentedLookup(startFragment, getMatchInFragment, searchTimestamp, latestTimestamp, options) {
    ...
    const lookupEntryPosition = Math.max(
      (lookupEntry == null ? void 0 : lookupEntry.moofOffset) ?? 0,
      (positionCacheEntry == null ? void 0 : positionCacheEntry.moofOffset) ?? 0
    ) || null;
    let currentPos;
    if (!startFragment) {
...
var MatroskaDemuxer = class extends Demuxer {
  ...
  async readSegment(segmentDataStart, dataSize) {
    ...
    while (this.currentSegment.elementEndPos === null || currentPos < this.currentSegment.elementEndPos) {
      ...
      const header = readElementHeader(slice);
      if (!header || !LEVEL_1_EBML_IDS.includes(header.id) && header.id !== 236) {
      ...
      } else if (id === 307544935 || id === 423732329) {
        if (id === 307544935) {
  ...
  async readCluster(startPos, segment) {
    ...
    for (const [, trackData] of cluster.trackData) {
      ...
      for (let i = 0; i < trackData.blocks.length; i++) {
        ...
        hasLacedBlocks || (hasLacedBlocks = block.lacing !== 0);
      }
  ...
  async loadSegmentMetadata(segment) {
    for (const seekEntry of segment.seekEntries) {
      if (seekEntry.id === 307544935 && !segment.tagsSeen) ;
      else if (seekEntry.id === 423732329 && !segment.attachmentsSeen) ;
      else {
        continue;
      }
      let slice = this.reader.requestSliceRange(
      ...
      this.currentSegment = null;
      if (seekEntry.id === 307544935) {
        segment.tagsSeen = true;
      } else if (seekEntry.id === 423732329) {
  ...
  traverseElement(slice, stopIds) {
    ...
    switch (id) {
      ...
      case 174:
        {
          ...
          if (this.currentTrack.decodingInstructions.some((instruction) => {
            var _a2;
            return ((_a2 = instruction.data) == null ? void 0 : _a2.type) !== "decompress" || instruction.scope !== 1 || instruction.data.algorithm !== 3;
          })) {
      ...
      case 224:
        {
          if (((_d = (_c = this.currentTrack) == null ? void 0 : _c.info) == null ? void 0 : _d.type) !== "video") break;
          this.readContiguousElements(slice.slice(dataStartPos, size));
        }
        break;
      case 176:
        {
          if (((_f = (_e = this.currentTrack) == null ? void 0 : _e.info) == null ? void 0 : _f.type) !== "video") break;
          this.currentTrack.info.width = readUnsignedInt(slice, size);
        }
        break;
      case 186:
        {
          if (((_h = (_g = this.currentTrack) == null ? void 0 : _g.info) == null ? void 0 : _h.type) !== "video") break;
          this.currentTrack.info.height = readUnsignedInt(slice, size);
        }
        break;
      case 21440:
        {
          if (((_j = (_i = this.currentTrack) == null ? void 0 : _i.info) == null ? void 0 : _j.type) !== "video") break;
          this.currentTrack.info.alphaMode = readUnsignedInt(slice, size) === 1;
        }
        break;
      case 21936:
        {
          if (((_l = (_k = this.currentTrack) == null ? void 0 : _k.info) == null ? void 0 : _l.type) !== "video") break;
      ...
      case 21937:
        {
          if (((_n = (_m = this.currentTrack) == null ? void 0 : _m.info) == null ? void 0 : _n.type) !== "video" || !this.currentTrack.info.colorSpace) break;
      ...
      case 21945:
        {
          if (((_p = (_o = this.currentTrack) == null ? void 0 : _o.info) == null ? void 0 : _p.type) !== "video" || !this.currentTrack.info.colorSpace) break;
          this.currentTrack.info.colorSpace.fullRange = readUnsignedInt(slice, size) === 2;
        }
        break;
      case 21946:
        {
          if (((_r = (_q = this.currentTrack) == null ? void 0 : _q.info) == null ? void 0 : _r.type) !== "video" || !this.currentTrack.info.colorSpace) break;
      ...
      case 21947:
        {
          if (((_t = (_s = this.currentTrack) == null ? void 0 : _s.info) == null ? void 0 : _t.type) !== "video" || !this.currentTrack.info.colorSpace) break;
      ...
      case 30320:
        {
          if (((_v = (_u = this.currentTrack) == null ? void 0 : _u.info) == null ? void 0 : _v.type) !== "video") break;
          this.readContiguousElements(slice.slice(dataStartPos, size));
        }
        break;
      case 30325:
        {
          if (((_x = (_w = this.currentTrack) == null ? void 0 : _w.info) == null ? void 0 : _x.type) !== "video") break;
      ...
      case 225:
        {
          if (((_z = (_y = this.currentTrack) == null ? void 0 : _y.info) == null ? void 0 : _z.type) !== "audio") break;
          this.readContiguousElements(slice.slice(dataStartPos, size));
        }
        break;
      case 181:
        {
          if (((_B = (_A = this.currentTrack) == null ? void 0 : _A.info) == null ? void 0 : _B.type) !== "audio") break;
          this.currentTrack.info.sampleRate = readFloat(slice, size);
        }
        break;
      case 159:
        {
          if (((_D = (_C = this.currentTrack) == null ? void 0 : _C.info) == null ? void 0 : _D.type) !== "audio") break;
          this.currentTrack.info.numberOfChannels = readUnsignedInt(slice, size);
        }
        break;
      case 25188:
        {
          if (((_F = (_E = this.currentTrack) == null ? void 0 : _E.info) == null ? void 0 : _F.type) !== "audio") break;
      ...
      case 16980:
        {
          if (((_L = (_K = this.currentDecodingInstruction) == null ? void 0 : _K.data) == null ? void 0 : _L.type) !== "decompress") break;
          this.currentDecodingInstruction.data.algorithm = readUnsignedInt(slice, size);
        }
        break;
      case 16981:
        {
          if (((_N = (_M = this.currentDecodingInstruction) == null ? void 0 : _M.data) == null ? void 0 : _N.type) !== "decompress") break;
  ...
  processTagValue(name, value) {
    var _a, _b;
    if (!((_a = this.currentSegment) == null ? void 0 : _a.metadataTags)) return;
...
var MatroskaTrackBacking = class {
  ...
  async performClusterLookup(startCluster, getMatchInCluster, searchTimestamp, latestTimestamp, options) {
    ...
    const lookupEntryPosition = Math.max(
      (cuePoint == null ? void 0 : cuePoint.clusterPosition) ?? 0,
      (positionCacheEntry == null ? void 0 : positionCacheEntry.elementStartPos) ?? 0
    ) || null;
    let currentPos;
    if (!startCluster) {
    ...
    while (segment.elementEndPos === null || currentPos <= segment.elementEndPos - MIN_HEADER_SIZE) {
      ...
      const elementStartPos = currentPos;
      const elementHeader = readElementHeader(slice);
      if (!elementHeader || !LEVEL_1_EBML_IDS.includes(elementHeader.id) && elementHeader.id !== 236) {
        const nextPos = await resync(
          demuxer.reader,
          elementStartPos,
          LEVEL_1_EBML_IDS,
...
var parseId3V1Tag = (slice, tags) => {
  ...
  if (title) tags.title ?? (tags.title = title);
  const artist = readId3V1String(slice, 30);
  if (artist) tags.artist ?? (tags.artist = artist);
  const album = readId3V1String(slice, 30);
  if (album) tags.album ?? (tags.album = album);
...
var parseId3V2Tag = (slice, header, tags) => {
  ...
  if (header.flags & 128 && header.majorVersion === 3) {
  ...
  while (reader.pos <= reader.bytes.length - reader.frameHeaderSize()) {
    ...
    if (header.majorVersion === 3) {
      ...
      frameUnsynchronized = !!(frame.flags & 1 << 1) || !!(header.flags & 128);
    }
    if (frameEncrypted) {
...
var MpegTsTrackBacking = class _MpegTsTrackBacking {
  ...
  async doPacketLookup(timestamp, keyframesOnly, options) {
    ...
    const retrieveEncodedPacket = async (sectionStartPos, predicate) => {
      ...
      const buffer = new PacketBuffer(this, context);
      while (true) {
        const topPts = ((_a = last(buffer.presentationOrderPackets)) == null ? void 0 : _a.pts) ?? -Infinity;
        if (topPts >= searchPts) {
          break;
        }
    ...
    while (true) {
      ...
      while (i < length) {
        ...
        if (nalUnitTypeByte !== null) {
          ...
          const isAud = codec === "avc" ? nalUnitType === 9 : nalUnitType === 35;
          if (isAud) {
  ...
  async _start() {
    ...
    const onAudioSample = (audioSample) => {
      ...
      void this._encoder.add(audioSample, true).catch((error) => {
        ...
        void ((_b = this._audioContext) == null ? void 0 : _b.suspend());
      });
    };
...
var validateVideoOptions = (videoOptions) => {
  ...
  if ((videoOptions == null ? void 0 : videoOptions.hardwareAcceleration) !== void 0 && !["no-preference", "prefer-hardware", "prefer-software"].includes(videoOptions.hardwareAcceleration)) {
    throw new TypeError(
...
var Conversion = class _Conversion {
  ...
  async _init() {
    var _a, _b;
    this._startTimestamp = ((_a = this._options.trim) == null ? void 0 : _a.start) ?? Math.max(
    ...
    this._endTimestamp = ((_b = this._options.trim) == null ? void 0 : _b.end) ?? Infinity;
...
export {
  ...
  Conversion as C,
  Input as I,
  Mp4OutputFormat as M,
  Output as O,
  QUALITY_VERY_LOW as Q,
  StreamTarget as S,
  UrlSource as U,
  BufferTarget as a,
  QUALITY_MEDIUM as b,
  canEncodeAudio as c,
  CanvasSource as d,
  MediaStreamAudioTrackSource as e,
  CanvasSink as f,
  AudioBufferSink as g,
  getFirstEncodableVideoCodec as h,
  QUALITY_HIGH as i,
  getFirstEncodableAudioCodec as j,
  AudioBufferSource as k
};
